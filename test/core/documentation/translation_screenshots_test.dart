...
import 'package:dev_studio/core/src/documentation/translation_screenshots.dart';
...
''');
  ...
  test('Generate screenshot filter code', () {
    ...
    expect(code, DartFormatter(languageVersion: DartFormatter.latestLanguageVersion).format('''
import 'translations_screenshots.gen.dart';
